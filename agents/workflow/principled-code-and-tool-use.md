...
We will write with consistent and centrilized principles / patterns for code
(see guide per language, tools etc) and tool use.

When developing in a lanugage or calling a tool, use its relevant skill and/or
