...
- Kind: agent guidance
- Source: `docs/library-curation/drafts/agents/diff-discipline.md`

## Verbatim Candidate

> # Keep Changes Minimal And Traceable
>
> Source: [`promisegrid_promisegrid_refs_heads_main_AGENTS.md`](../reference/source-guides/promisegrid_promisegrid_refs_heads_main_AGENTS.md#diff-discipline-required)
>
